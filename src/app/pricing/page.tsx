    ...
    <>
      ...
      <div style={{ background: '#060A04', color: 'white', fontFamily: 'Inter,system-ui,sans-serif', minHeight: '100vh' }}>
        ...
        <section className="reveal" style={{ padding: '0 3rem 6rem', textAlign: 'center' }}>
          ...
          <p style={{ fontStyle: 'italic', color: 'rgba(255,255,255,0.5)', maxWidth: '600px', margin: '0 auto 0.8rem', fontSize: '1rem', lineHeight: 1.75 }}>&ldquo;CropGuard paid for itself in the first harvest season. The ROI was immediate.&rdquo;</p>
